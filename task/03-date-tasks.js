...
function timeSpanToString(startDate, endDate) {
  ...
  return `${hours.length < 2 ? '0' + hours : hours}:${minutes.length < 2 ? '0' + minutes : minutes}:${seconds.length < 2 ? '0' + seconds : seconds}.${milliseconds.length < 3 ? milliseconds+'00' : milliseconds}`;
}
